...
export default async (client?: Client) => {
  let cmds: {name: Command["name"]; description: Command["description"]; options: Command["options"]}[] = []; // Создаем пустой массив команд
  let cmdx: {name?: Command["name"]; description?: Command["description"]; options?: Command["options"]; type?: number; value?: Command["name"]}[] = [];
